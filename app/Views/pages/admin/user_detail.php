      ...
      <div class="card-body p-3">
        <div class="row gx-4">
          ...
          <div class="col-auto my-auto">
            <div class="h-100">
              <h5 class="mb-1 fullname-content">
                Sayo Kravits
              </h5>
              <p class="mb-0 font-weight-bold text-sm job-name-content">
                Public Relations
              </p>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <span class="text-sm fullname-content">Luthfi Anum Pratama</span>
                </div>
                <div class="col-md-6 mb-3">
                  <p class="mb-0 text-sm font-weight-bold ">Email</p>
                  <span class="text-sm email-content">Luthfianump@gmail.com</span><span class="text-success"><i class="ni ni-check-bold"></i></span>
                </div>
                <div class="col-md-6 mb-3">
                  <p class="mb-0 text-sm font-weight-bold ">Job</p>
                  <span class="text-sm job-name-content">Software Engineer</span>
                </div>
                <div class="col-md-6 mb-3">
