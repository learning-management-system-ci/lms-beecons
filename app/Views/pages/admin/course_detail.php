          ...
          <div class="card tab-pane fade" id="video" role="tabpanel" aria-labelledby="video-tab">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                ...
                <button class="btn btn-primary btn-sm ms-auto" onclick="startCreateVideo()">Add New Video</button>
              </div>
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
              <div class="row ">
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Title</label>
                    <input class="form-control title-content-setting" type="text" id="title-input-add">
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
